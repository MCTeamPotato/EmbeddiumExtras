...
public class EmbeddiumExtrasConfig {
    ...
    static {
        ...
        builder.block("Entity List", b -> {
            ...
            final List<? extends String> tileEntityModidList = ObjectArrayList.wrap(new String[]{"create"});
            final List<? extends String> entityModidList = ObjectArrayList.wrap(new String[]{"witherstormmod", "create"});
